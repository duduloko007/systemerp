...
/*
	...
	public function edit($id, $id_company,  $name = '', $email = '', $phone = '',$phone_fix = '', $stars = '3',  $internal_obs = '', $address_zipcode = '', $address = '', $address_number = '',  $address2 = '', $address_neighb = '',  $address_city = '', $address_state = '', $address_country = '', $cpf_cnpj = '', $identidade = '', $date_birth_fund = '', $name_fantasy = '', $state_registration = '', $municipal_registration = ''){

		$sql = $this->db->prepare("UPDATE clients SET name = :name, email = :email, phone = :phone, phone_fix = :phone_fix, stars = :stars, internal_obs = :internal_obs, address_zipcode = :address_zipcode, address = :address, address_number = :address_number, address2 = :address2, address_neighb = :address_neighb, address_city = :address_city, address_state = :address_state, address_country = :address_country, cpf_cnpj = :cpf_cnpj, identidade = :identidade, date_birth_fund = :date_birth_fund,name_fantasy = :name_fantasy, state_registration = :state_registration, municipal_registration = :municipal_registration WHERE id = :id AND id_company = :id_company2");
