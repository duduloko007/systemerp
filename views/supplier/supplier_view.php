  ...
  <form method="POST">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="text" name="cpf_cnpj" id="cpf_cnpj" class="form-control" disabled value="<?php echo utf8_decode($client_info['cpf_cnpj']); ?>">
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
            <label>Inscrição estadual:</label>
            <input type="text" name="inscri_estadual" id="inscri_estadual" class="form-control" disabled value="<?php echo utf8_decode($client_info['inscri_estadual']); ?>">
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
      ...
      <div class="col-md-6">
        <div class="form-group">
          <label>Estado:</label>
          <input type="text" name="address_state" class="form-control " disabled value="<?php echo $client_info['address_state']; ?>">
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
      ...
      <div class="col-md-12">
        <div class="form-group">
          ...
          <textarea name="internal_obs" disabled class="form-control"><?php echo utf8_decode($client_info['internal_obs']); ?></textarea>
        </div>
      </div>
    </div>
    <a href="<?php echo BASE_URL;?>supplier" class="btn btn-danger btn-sm">Voltar</a>
  </div>
</form>
</div>
